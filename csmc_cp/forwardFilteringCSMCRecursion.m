function [SS_updated,log_Wbar_updated] = forwardFilteringCSMCRecursion(...
    n,N,tau_star,SS_nm1,log_W_nm1,params)
...
if n<=(N+1)
    ...
    if any(tau_kappa==I_nm1)
        ...
        [ O_nm1 ] = conditionalStratifiedResampling( tau_kappa,I_nm1,...
            W_for_I_nm1,N,L_nm1 );
...
%log_gn_1 = log_gn(n,n-1,params);
log_gn_1 = predictiveCopula( n,n-1, params );
log_Wbar_n_nm1 = log_gn_1 + ...
...
for i=1:card_SS
    xnm1 = SS_nm1(i);
    log_W_val = log_W_nm1(i);
    %log_gn_i = log_gn(n,xnm1,params);
    [ log_gn_i ] = predictiveCopula( n,xnm1, params );
    log_Wbar_arr(i) = log_gn_i + ...
